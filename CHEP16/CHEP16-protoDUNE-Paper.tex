...
instances of the \textit{Fermi FTS} system \cite{fts} which transports data between a few endpoints.
There is more than once instance of FTS in the data transmission chain.
