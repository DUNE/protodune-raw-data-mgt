...
at CERN. The rate and the volume of raw data to be collected during the projected 2-month
test  are substantial and on par with the LHC experiments in LHC Run 1.
The protoDUNE experiment will require careful design of the DAQ, data handling and
