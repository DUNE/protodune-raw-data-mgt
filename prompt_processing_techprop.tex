...
This note describes design parameters of the Prompt Processing system, and one
particular design option for such system. We start with a brief summary of the data characteristics
...
A design of the \PP System is proposed with a focus on dataflow, throughput and pre-scaling of
the input data which satisfies these requirements. It employs a dynamically prioritized job queue.
\end{abstract}
...
\label{sec:rawdata}
Quantitative information about scenarios for data taking in \pd is collected and maintained in \cite{docdb1086}.
