...
the \pd Production Systems. Having prototypes in place is therefore crucial on the time
...
``captures'' these data and commits it either to a database managed by \pd or as files on disk (EOS). A prototype
...
\item  \textbf{Calibration and Production}. This includes running prototypes of this software utilizing the FNAL POMS.
...
These data do not need to be real at this poin, as the purpose of this step is to test interfaces and protocols.
